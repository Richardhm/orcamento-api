...
<head>
    ...
    <style>
        ...
        .bloco {
            ...
            box-shadow: 0 2px 5px rgba(255,255,255,0.5); /* Sombra suave */
...
<div class="container">
    ...
    <table class="bloco-container" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            @if($com_coparticipacao == 1)
                ...
                <td class="bloco" style="width:38%;margin: {{ $margins[$totalBlocos] }};">
            ...
            @if($sem_coparticipacao == 1)
                ...
                <td class="bloco-amarelo" style="width: 38%;{{$totalBlocos <= 2 ? 'margin-left:1%;' : 'margin-left:0%;'}} ">

                    <table width="100%">

                        <tr>
                            <td colspan="2" class="header-orange-parcial" style="text-align:center;font-size:1.4em;">
                                @if($administradora == "Hapvida" && ($cidade == "Goiânia" || $cidade == "Anápolis"))
                                    21034 |
                                @endif
                                @if($corretora == 1)
    ...
    @if($desconto == 1)
        <table class="bloco-container-desconto" style="margin-top:10px;" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td class="bloco-laranja-desconto" style="width: 22%; {{$totalBlocos <= 2 ? 'margin-left:20%;' : 'margin-left:0%;'}}">
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <td>
                            <div class="valor-copart-desconto-azul" style="border-radius:50px;font-size: 1.3em;">
                ...
                <td class="bloco-laranja-desconto" style="width: 38%;margin:0 1%;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td>
                                <div class="valor-copart-desconto-azul" style="border-radius:50px;font-size: 1.3em;">
                ...
                <td class="bloco-laranja-desconto" style="width: 38%;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td>
